...
export default function Page() {
  ...
  const API_KEY = '8b9cadaddd5fdf77e1118c4b03b79f77'; // сюда вставь ключ TMDB
            ...
            <Meta
              ...
              description={
                <>
                  ...
                  <Tag color="gold">
                    ⭐ {userRating ?? movie.vote_average ? userRating ?? movie.vote_average.toFixed(1) : 'N/A'}
                  </Tag>
                  <Rate
                    allowHalf
                    disabled
                    defaultValue={userRating ?? movie.vote_average / 2}
                  />
                </>
              }
            />
