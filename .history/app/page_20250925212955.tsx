...
// TODO: ensure debounce cleanup (clear timeouts / cancel on unmount) added by automated script
...
{Array.isArray(movies) && movies.length === 0 ? <p>ничего не найдено</p> : null}
                {{Array.isArray(movies) && movies.length === 0 ? (<p>ничего не найдено</p>) : null}
